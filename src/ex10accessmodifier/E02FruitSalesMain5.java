...
class FruitSeller3{
	...
	public FruitSeller3(int money, int appleNum, int price) { //그래서 void도 삭제, 이름도 변경 클래스명과 생성자 명은 동일해야해서
		myMoney = money;
		numOfApple = appleNum;
		APPLE_PRICE = price;
	}
...
public class E02FruitSalesMain5 {
	...
	public static void main(String[] args) {
		...
		즉, 코드(메서드)로 구현한 규칙이 완전히 무너지게 되었다.
		객체지향 프로그래밍에서느 이런 오류를 막기위해 멤버변수에 대한 
		"정보은닉"을 하도록 규정하고 있다.
		 */
