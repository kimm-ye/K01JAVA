...
public class E03SingleToneDesignPattern {
	...
	public static void main(String[] args) {
		...
		//SingleTone st1 = new NoSingleTone(); //오류발생 private라 new를 쓸수 없다
		
		SingleTone st2 = SingleTone.getInstance(); //new가 아닌 getInstance로 객체 반환 받아서 써야한다.
		st2.shareVar = 100;
		st2.print();
		
		SingleTone st3 = SingleTone.getInstance();
		st3.shareVar = 200; //새로운 값으로 바뀌는게 아니니까 마지막 값으로 덮어씌워짐
		st3.print();
