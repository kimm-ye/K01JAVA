...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		 ...
		 */
		/*
		codePointAt() : 문자열에서 index에 해당되는 한 문자의 아스키코드 값을 반환한다.
		 */
		...
		int whiteCount = 0;
		char[] chArr = whiteString.toCharArray(); //공백이 있는지 없는지만 판단해주는거니까 갯수를 찾으려면 배열로 구해야 한다.
