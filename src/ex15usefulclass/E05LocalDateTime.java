...
public class E05LocalDateTime {
	...
	public static void main(String[] args) {
		...
		DateTimeFormatter format3 = DateTimeFormatter.ofPattern("오늘은 yyyy년 w주차, D번째날");
		DateTimeFormatter format4 = DateTimeFormatter.ofPattern("오늘은 M월 W전째주, d번째날, F번째 E요일");
		...
		//원하는 날짜로 설정한다. 올해 크리스마스의 경우
		LocalDate xMas =  LocalDate.of(localDate.getYear(), 12, 25);
		System.out.println("올해크리스마스까지...");
