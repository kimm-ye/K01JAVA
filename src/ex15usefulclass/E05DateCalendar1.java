...
public class E05DateCalendar1 {
	...
	/*
	myDiffDate = 특정날짜를 지정하여 남은 날짜를 계산하여 반환하는 메서드.
	여러개의 값을 반환하고 싶을때는 배열을 이용할 수 있다.
	 */
	public static String[] myDiffDate() throws ParseException { //여러개의 반환값이 있었음 좋을때, 그래서 배열로 사용 (혹은 컬렉션)
		//우리가 사용하는 날짜의 포맷형식
		String today = "2021/10/11";
		String future = "2021/12/25";
		
//	public static String[] myDiffDate(String today,String future) throws ParseException { //여러개의 반환값이 있었음 좋을때, 그래서 배열로 사용 (혹은 컬렉션)
//		//우리가 사용하는 날짜의 포맷형식
//		String today = "2021/10/11";
//		String future = "2021/12/25";
	...
	public static void main(String[] args) throws ParseException {
		...
		//Calendar 클래스는 대표적인 싱글톤이므로 new로 생성하지 않는다. //많이 쓰니까 객체 또 만들지 말고 그냥 써~~의미
		Calendar calendar = Calendar.getInstance();
		
		//여러가지 서식문자 활용하기
		System.out.println("오늘날짜:" + myDateFormat(calendar, "yyyy-MM-dd"));
		System.out.println("현재시간:" + myDateFormat(calendar, "HH:mm:ss"));
		System.out.println(myDateFormat(calendar, "오늘은 yyyy년 w주차, D번째날"));
		...
		String dateStr5 = myDateFormat(calendar2, "yyyy-MM-dd");
