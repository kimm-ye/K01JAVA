...
다형성(Polymorphism)
	...
	2. 이 경우 동질화(Homogeneous:호모지니어스)라고 한다.
 */
class Parent{
	int parentMember;
...
public class E11Polymorphism {
	...
	public static void main(String[] args) {
		...
		/*동질화의 경우 객체 전체를 접근할 수 있다.
		 ...
		 왜냐면 자신의 참조변수로 자신의 객체를 참조하는 거니까
		 */
		...
		이질화 : 부모타입의 변수로 자식 객체를 참조하는 것.
			...
			이질화의 경우 자기자신만 생각하면 된다.
		 */
		System.out.println("[부모타입에 자식타입의 메모리 복사]");
