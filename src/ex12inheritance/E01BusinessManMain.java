...
class Man{
	//멤버변수는 private로 정의했으므로 클래스 내부에서만 접근가능
	private String name;
...
class BusinessMan extends Man{
	...
	public BusinessMan(String name, String company, String position) {
		...
		super를 지우면 에러가 나지는 않지만 
		 */
		super(name); //부모클래스의 매개변수 1개인 생성자를 호춣한다.
	...
	public void tellYourInfo() {
		...
		/*
		부모쪽의 멤버변수 name은 private으로 선언되었으므로 상속 받은
		자식에서도 접근이 불가능하다.
		private는 무조건 자신의 클래스 내에서만 접근할 수 있다.
		 */
		//System.out.println("이름은 " + name + "입니다."); name이 private라 자식이어도 접근불가, 에러발생
