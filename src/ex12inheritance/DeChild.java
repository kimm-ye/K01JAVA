...
public class DeChild extends DeParent {
	...
	오버라이딩 아님
		...
		자식쪽에서는 보이지 않아 오버라이딩 대상이 될 수 없다.
		해당 함수는 자식쪽에서 새롭게 확장한 메서드가 된다.
	 */
	private void eat() { //private은 클래스 안에서만 사용할 수 있으니까 오버라이딩 안됨!!!
	...
	그 보다 넓으면 오버라이딩이 가능하다.
	
	아래는 default < public이므로 가능
	 */
	@Override
	public String sleep() {
