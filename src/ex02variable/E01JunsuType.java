...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		/*
		정수자료형
		-byte, short, int, long 타입(형)이 잇다.
		-각 자료형의 표현범위는 교얀을 참조한다(외울필요없음)
		...
		/*
		-int형보다 작은 자료형을 연산하면 컴파일러는 int형으로 변현하여
		연산한다.
		-CPU가 int형의 연산에 최적화 되어 있기 때문이다.
		-byte, short 형은 게임케릭터의 움직임이나 음원정보 등을 표현할때
		주로 사용된다.
		 */
		 ...
		 */
		//long long3 = 22000000; =>에러발생됨
		long long4 = 22000000L; // 접미사를 붙여야만
		long long5 = 22000000l; // 에러가 발생하지 않음
