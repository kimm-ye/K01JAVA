...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		//크기가 3인 정수형 배열 선언
		int [] numArr = new int[3]; //numArr은 참조형 변수
		//인덱스 0부터 배열 초기화
		numArr[0] = 10;
		numArr[1] = 20;
		numArr[2] = 30;
		...
		//베열의 크기가 변경되는 경우 해당 for문도 변경해야한다.
		for(int i=0; i<4; i++) { 
			//각 배열요소 출력
		...
		초기값의 갯수를 통해 크기를 결정할 수 있다.
		따라서 이런 경우 크기는 생략하도록 약속되어 있다.
		 */
		System.out.println("방법2 : 선언과 동시에 초기화");
		//int[] initArr2 = new int[3] {1,2,3}; //에러발생
		int[] initArr2 = new int[] {1,2,3};
