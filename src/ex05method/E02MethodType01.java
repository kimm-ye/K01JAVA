...
Java에서의 NamingRule(이름규칙)
	...
	-패키지명 : simpel.func => 전체를 소문자로, 연결단어는 .(점)으로 표현
*/
public class E02MethodType01 {
	
	//반환타입, 매개변수 둘다 없는 타입의 메서드 정의
	static void noParanNoReturn() {
	 ...
	 */
	static void noParanNoReturn2() {
	}
	/*
	동일한 이름의 메서드를 정의하였으나 매개변수의 갯수로 호출할 대상을 구분할 수 있으므로
	다른 함수라 생각하면 되고, 이와 같은 문법을 "메서드 오버로딩" 이라 한다.
	 */
	static void noParanNoReturn2(int a) {
	}
	
	static void noParanNoReturn3() {
		int returnValue = 89;
